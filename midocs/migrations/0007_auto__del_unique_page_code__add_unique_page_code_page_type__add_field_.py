...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field related_videos on 'Page'
        m2m_table_name = db.shorten_name(u'midocs_page_related_videos')
        ...
        db.create_unique(m2m_table_name, ['page_id', 'video_id'])

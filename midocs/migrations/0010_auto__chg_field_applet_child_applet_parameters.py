...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Applet.child_applet_parameters'
        db.alter_column(u'midocs_applet', 'child_applet_parameters', self.gf('django.db.models.fields.CharField')(max_length=400, null=True))

    def backwards(self, orm):

        # Changing field 'Applet.child_applet_parameters'
        db.alter_column(u'midocs_applet', 'child_applet_parameters', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))
    ...
    models = {
        u'midocs.applet': {
            ...
            'child_applet_parameters': ('django.db.models.fields.CharField', [], {'max_length': '400', 'null': 'True', 'blank': 'True'}),

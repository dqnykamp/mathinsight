...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AppletObject.category_for_capture'
        db.add_column(u'midocs_appletobject', 'category_for_capture',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AppletObject.category_for_capture'
        db.delete_column(u'midocs_appletobject', 'category_for_capture')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AppletObject.default_value'
        db.add_column(u'midocs_appletobject', 'default_value',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AppletObject.default_value'
        db.delete_column(u'midocs_appletobject', 'default_value')

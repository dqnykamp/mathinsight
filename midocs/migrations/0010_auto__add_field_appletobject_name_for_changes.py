...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AppletObject.name_for_changes'
        db.add_column(u'midocs_appletobject', 'name_for_changes',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AppletObject.name_for_changes'
        db.delete_column(u'midocs_appletobject', 'name_for_changes')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Applet.child_applet_percent_width'
        db.add_column(u'midocs_applet', 'child_applet_percent_width',
                      self.gf('django.db.models.fields.IntegerField')(default=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Applet.child_applet_percent_width'
        db.delete_column(u'midocs_applet', 'child_applet_percent_width')

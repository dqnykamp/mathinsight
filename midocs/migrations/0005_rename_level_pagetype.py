...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Rename model 'Level' to 'PageType' and alter columns
        db.rename_table(u'midocs_level', u'midocs_pagetype')

        db.rename_column(u'midocs_pagetype', 'description', 'name')
        
        db.alter_column(u'midocs_pagetype', 'name', models.CharField(max_length=100))

        db.rename_column(u'midocs_page', 'level_id', 'page_type_id')


    def backwards(self, orm):

        # Rename model 'PageType' to 'Level' and alter columns
        db.rename_table(u'midocs_pagetype', u'midocs_level')

        db.rename_column(u'midocs_level', 'name', 'description')
        
        db.alter_column(u'midocs_level', 'description', models.CharField(max_length=400))

        db.rename_column(u'midocs_page', 'page_type_id', 'level_id')
    ...
    models = {
        ...
        u'midocs.page': {
            ...
            'page_type': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': u"orm['midocs.PageType']"}),
            'publish_date': ('django.db.models.fields.DateField', [], {'db_index': 'True', 'blank': 'True'}),

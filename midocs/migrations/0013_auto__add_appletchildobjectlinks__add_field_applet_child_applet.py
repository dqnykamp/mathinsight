...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Applet.child_applet'
        db.add_column(u'midocs_applet', 'child_applet',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['midocs.Applet'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Applet.child_applet'
        db.delete_column(u'midocs_applet', 'child_applet_id')

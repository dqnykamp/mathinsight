...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AppletObject.state_variable'
        db.add_column(u'midocs_appletobject', 'state_variable',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AppletObject.state_variable'
        db.delete_column(u'midocs_appletobject', 'state_variable')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'IndexEntry.page_anchor'
        db.alter_column(u'midocs_indexentry', 'page_anchor', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

        # Changing field 'IndexEntry.indexed_subphrase'
        db.alter_column(u'midocs_indexentry', 'indexed_subphrase', self.gf('django.db.models.fields.CharField')(max_length=100, null=True))

    def backwards(self, orm):

        # Changing field 'IndexEntry.page_anchor'
        db.alter_column(u'midocs_indexentry', 'page_anchor', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

        # Changing field 'IndexEntry.indexed_subphrase'
        db.alter_column(u'midocs_indexentry', 'indexed_subphrase', self.gf('django.db.models.fields.CharField')(default='', max_length=100))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Page.template_modified'
        db.delete_column(u'midocs_page', 'template_modified')

        # Deleting field 'Page.template_dir'
        db.delete_column(u'midocs_page', 'template_dir')


        # Changing field 'Page.title'
        db.alter_column(u'midocs_page', 'title', self.gf('django.db.models.fields.CharField')(default='none', max_length=200))

    def backwards(self, orm):
        # Adding field 'Page.template_modified'
        db.add_column(u'midocs_page', 'template_modified',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Page.template_dir'
        db.add_column(u'midocs_page', 'template_dir',
                      self.gf('django.db.models.fields.CharField')(default='none', max_length=200),
                      keep_default=False)


        # Changing field 'Page.title'
        db.alter_column(u'midocs_page', 'title', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

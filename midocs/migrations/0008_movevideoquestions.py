...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for video in orm.Video.objects.all():
            for question in video.question_set.all():
                video.videoquestion_set.create(question=question)


    def backwards(self, orm):
        for videoquestion in orm.VideoQuestion.objects.all():
            videoquestion.question.video = videoquestion.video
            videoquestion.question.save()
    ...
    models = {
        ...
        u'midocs.video': {
            ...
            'publish_date': ('django.db.models.fields.DateField', [], {'db_index': 'True', 'blank': 'True'}),
            'questions': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'newvideos'", 'to': u"orm['mitesting.Question']", 'through': u"orm['midocs.VideoQuestion']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
            'subjects': ('django.db.models.fields.related.ManyToManyField', [], {'symmetrical': 'False', 'to': u"orm['midocs.Subject']", 'null': 'True', 'blank': 'True'}),
            'thumbnail': ('django.db.models.fields.files.ImageField', [], {'max_length': '150', 'null': 'True', 'blank': 'True'}),
            'thumbnail_height': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'thumbnail_width': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),

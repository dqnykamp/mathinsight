...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'midocs_image', 'imagefile', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))

        # Changing field 'Image.height'
        db.alter_column(u'midocs_image', 'height', self.gf('django.db.models.fields.IntegerField')(null=True))

        # Changing field 'Image.width'
        db.alter_column(u'midocs_image', 'width', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'Image.imagefile'
        raise RuntimeError("Cannot reverse this migration. 'Image.imagefile' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Image.imagefile'
        db.alter_column(u'midocs_image', 'imagefile', self.gf('django.db.models.fields.files.ImageField')(max_length=100))
        ...
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Image.height'
        db.alter_column(u'midocs_image', 'height', self.gf('django.db.models.fields.IntegerField')())
        ...
        # The following code is provided here to aid in writing a correct migration
        # Changing field 'Image.width'
        db.alter_column(u'midocs_image', 'width', self.gf('django.db.models.fields.IntegerField')())

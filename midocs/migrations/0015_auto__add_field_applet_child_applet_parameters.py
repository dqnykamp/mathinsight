...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Applet.child_applet_parameters'
        db.add_column(u'midocs_applet', 'child_applet_parameters',
                      self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Applet.child_applet_parameters'
        db.delete_column(u'midocs_applet', 'child_applet_parameters')

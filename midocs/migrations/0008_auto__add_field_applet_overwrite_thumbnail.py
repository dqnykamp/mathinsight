...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Applet.overwrite_thumbnail'
        db.add_column(u'midocs_applet', 'overwrite_thumbnail',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=1),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Applet.overwrite_thumbnail'
        db.delete_column(u'midocs_applet', 'overwrite_thumbnail')

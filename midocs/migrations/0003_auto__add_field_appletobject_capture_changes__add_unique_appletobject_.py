...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AppletObject.capture_changes'
        db.add_column(u'midocs_appletobject', 'capture_changes',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AppletObject.capture_changes'
        db.delete_column(u'midocs_appletobject', 'capture_changes')

...
#    url(r'^ajax/hit/$', update_hit_count_ajax, name='hitcount_update_ajax'), 
    ...
    url(r'^question/', include('mitesting.urls', namespace="miquestion")),
    url(r'^assess/', include('micourses.assessment_urls',namespace="miassess")),
    url(r'^thread/', include('micourses.thread_urls', namespace="mithreads")),

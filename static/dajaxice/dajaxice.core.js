...
var Dajaxice = {
    ...
    edit_content: function(callback_function, argv, custom_settings){
        return Dajaxice.call('midocs.edit_content', 'POST', callback_function, argv, custom_settings);
    },
    ...
    move_section_down: function(callback_function, argv, custom_settings){
        return Dajaxice.call('midocs.move_section_down', 'POST', callback_function, argv, custom_settings);
    },
    ...
    cancel_insert_content_below_section: function(callback_function, argv, custom_settings){
        return Dajaxice.call('midocs.cancel_insert_content_below_section', 'POST', callback_function, argv, custom_settings);
    },

    cancel_edit_section: function(callback_function, argv, custom_settings){
    ...
    insert_section_below: function(callback_function, argv, custom_settings){
        return Dajaxice.call('midocs.insert_section_below', 'POST', callback_function, argv, custom_settings);
    },

    insert_content_form_below_section: function(callback_function, argv, custom_settings){
        return Dajaxice.call('midocs.insert_content_form_below_section', 'POST', callback_function, argv, custom_settings);
    },
    ...
    confirm_edit_section: function(callback_function, argv, custom_settings){
        return Dajaxice.call('midocs.confirm_edit_section', 'POST', callback_function, argv, custom_settings);
    },

    confirm_edit_content: function(callback_function, argv, custom_settings){
        return Dajaxice.call('midocs.confirm_edit_content', 'POST', callback_function, argv, custom_settings);
    },

    confirm_delete_section: function(callback_function, argv, custom_settings){
        return Dajaxice.call('midocs.confirm_delete_section', 'POST', callback_function, argv, custom_settings);
    },

    delete_section: function(callback_function, argv, custom_settings){
    ...
    delete_content: function(callback_function, argv, custom_settings){
        return Dajaxice.call('midocs.delete_content', 'POST', callback_function, argv, custom_settings);
    },

    insert_section_form_top: function(callback_function, argv, custom_settings){
        return Dajaxice.call('midocs.insert_section_form_top', 'POST', callback_function, argv, custom_settings);
    },

    insert_content_below_section: function(callback_function, argv, custom_settings){
        return Dajaxice.call('midocs.insert_content_below_section', 'POST', callback_function, argv, custom_settings);
    },

    cancel_edit_content: function(callback_function, argv, custom_settings){
        return Dajaxice.call('midocs.cancel_edit_content', 'POST', callback_function, argv, custom_settings);
    },

    edit_section: function(callback_function, argv, custom_settings){
        return Dajaxice.call('midocs.edit_section', 'POST', callback_function, argv, custom_settings);
    }

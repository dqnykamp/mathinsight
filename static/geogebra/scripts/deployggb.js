...
//            resource3.src = preCompiledResourcePath+'/mathquillggb.js';
            ...
            resource4.innerHTML = '\n' +
                ...
                '                       window.ggbApplets[i].init({scale:window.ggbApplets[i].scaleParameter, url:window.ggbApplets[i].preCompiledScriptPath+"/", ss:'+(parameters.showSplash?'true':'false')+', sdz:'+(parameters.enableShiftDragZoom?'true':'false')+', rc:'+(parameters.enableRightClick?'true':'false')+'});' +
                '                   }' +
                '               }' +
...
//            appletElem.appendChild(resource3);
        ...
        var scriptLoaded = function() {
            ...
            if (ggbCompiledResourcesLoadFinished) {
                window[appletObjectName].init({scale:parameters.scale, url:preCompiledScriptPath+'/', ss:parameters.showSplash, sdz:parameters.enableShiftDragZoom, rc:parameters.enableRightClick});

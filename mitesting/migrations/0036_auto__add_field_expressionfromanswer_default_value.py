...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExpressionFromAnswer.default_value'
        db.add_column(u'mitesting_expressionfromanswer', 'default_value',
                      self.gf('django.db.models.fields.CharField')(default=u'[?]', max_length=20),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExpressionFromAnswer.default_value'
        db.delete_column(u'mitesting_expressionfromanswer', 'default_value')
    ...
    models = {
        ...
        u'mitesting.expressionfromanswer': {
            ...
            'default_value': ('django.db.models.fields.CharField', [], {'default': "u'[?]'", 'max_length': '20'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

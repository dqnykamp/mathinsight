...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'mitesting_assessment', 'notes',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)

        # Adding M2M table for field keywords on 'Question'
        db.create_table(u'mitesting_question_keywords', (
        ...
        db.create_unique(u'mitesting_question_keywords', ['question_id', 'keyword_id'])

        # Adding M2M table for field subjects on 'Question'
        db.create_table(u'mitesting_question_subjects', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('question', models.ForeignKey(orm[u'mitesting.question'], null=False)),
            ('subject', models.ForeignKey(orm[u'midocs.subject'], null=False))
        ))
        db.create_unique(u'mitesting_question_subjects', ['question_id', 'subject_id'])


    def backwards(self, orm):
        # Deleting field 'Assessment.notes'
        db.delete_column(u'mitesting_assessment', 'notes')

        # Removing M2M table for field keywords on 'Question'
        db.delete_table('mitesting_question_keywords')

        # Removing M2M table for field subjects on 'Question'
        db.delete_table('mitesting_question_subjects')

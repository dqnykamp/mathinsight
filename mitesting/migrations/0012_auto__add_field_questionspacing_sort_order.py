...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestionSpacing.sort_order'
        db.add_column(u'mitesting_questionspacing', 'sort_order',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestionSpacing.sort_order'
        db.delete_column(u'mitesting_questionspacing', 'sort_order')

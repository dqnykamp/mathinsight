...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlotFunction.invert'
        db.add_column(u'mitesting_plotfunction', 'invert',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlotFunction.invert'
        db.delete_column(u'mitesting_plotfunction', 'invert')

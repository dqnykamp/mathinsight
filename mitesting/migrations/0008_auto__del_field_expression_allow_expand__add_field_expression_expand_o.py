...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Expression.allow_expand'
        db.delete_column(u'mitesting_expression', 'allow_expand')

        # Adding field 'Expression.expand_on_compare'
        db.add_column(u'mitesting_expression', 'expand_on_compare',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Expression.tuple_is_ordered'
        db.add_column(u'mitesting_expression', 'tuple_is_ordered',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Expression.allow_expand'
        db.add_column(u'mitesting_expression', 'allow_expand',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'Expression.expand_on_compare'
        db.delete_column(u'mitesting_expression', 'expand_on_compare')

        # Deleting field 'Expression.tuple_is_ordered'
        db.delete_column(u'mitesting_expression', 'tuple_is_ordered')

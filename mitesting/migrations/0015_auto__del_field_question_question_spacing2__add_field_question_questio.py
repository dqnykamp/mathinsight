...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'Question.question_spacing2' to 'Question.question_spacing'
        db.rename_column(u'mitesting_question', 'question_spacing2', 'question_spacing')


        # Renaming field 'QuestionSubpart.question_spacing2' to 'QuestionSubpart.question_spacing'
        db.rename_column(u'mitesting_questionsubpart', 'question_spacing2', 'question_spacing')

    def backwards(self, orm):
        # Renaming field 'Question.question_spacing' to 'Question.question_spacing2'
        db.rename_column(u'mitesting_question', 'question_spacing', 'question_spacing2')

        # Renaming field 'QuestionSubpart.question_spacing' to 'QuestionSubpart.question_spacing2'
        db.rename_column(u'mitesting_questionsubpart', 'question_spacing', 'question_spacing2')

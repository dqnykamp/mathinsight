...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Expression.figure'
        db.delete_column(u'mitesting_expression', 'figure')

        # Deleting field 'Expression.linestyle'
        db.delete_column(u'mitesting_expression', 'linestyle')

        # Deleting field 'Expression.xmax'
        db.delete_column(u'mitesting_expression', 'xmax')

        # Deleting field 'Expression.xmin'
        db.delete_column(u'mitesting_expression', 'xmin')

        # Deleting field 'Expression.linewidth'
        db.delete_column(u'mitesting_expression', 'linewidth')


    def backwards(self, orm):
        # Adding field 'Expression.figure'
        db.add_column(u'mitesting_expression', 'figure',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Expression.linestyle'
        db.add_column(u'mitesting_expression', 'linestyle',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Expression.xmax'
        db.add_column(u'mitesting_expression', 'xmax',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Expression.xmin'
        db.add_column(u'mitesting_expression', 'xmin',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Expression.linewidth'
        db.add_column(u'mitesting_expression', 'linewidth',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

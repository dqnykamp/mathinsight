...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        try:
            public=orm.QuestionPermission.objects.get(name="Public")
        except ObjectDoesNotExist:
            public = orm.QuestionPermission.objects.create\
                (name="Public", privacy_level=0, privacy_level_solution=0)
        ...
        try:
            ...
            public_private = orm.QuestionPermission.objects.create\
                (name="Public with private solution", privacy_level=0, privacy_level_solution=2)
        ...
        try:
            ...
            private = orm.QuestionPermission.objects.create\
                (name="Private", privacy_level=0, privacy_level_solution=2)
    ...
    models = {
        ...
        u'mitesting.question': {
            ...
            'notes': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'question_permission': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mitesting.QuestionPermission']", 'null': 'True', 'blank': 'True'}),

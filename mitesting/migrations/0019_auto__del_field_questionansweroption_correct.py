...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'QuestionAnswerOption.correct'
        db.delete_column(u'mitesting_questionansweroption', 'correct')


    def backwards(self, orm):
        # Adding field 'QuestionAnswerOption.correct'
        db.add_column(u'mitesting_questionansweroption', 'correct',

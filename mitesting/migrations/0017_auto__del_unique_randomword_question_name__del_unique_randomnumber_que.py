...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'Expression', fields ['question', 'name']
        db.delete_unique(u'mitesting_expression', ['question_id', 'name'])

        # Removing unique constraint on 'RandomNumber', fields ['question', 'name']
        db.delete_unique(u'mitesting_randomnumber', ['question_id', 'name'])

        # Removing unique constraint on 'RandomWord', fields ['question', 'name']
        db.delete_unique(u'mitesting_randomword', ['question_id', 'name'])


    def backwards(self, orm):
        # Adding unique constraint on 'RandomWord', fields ['question', 'name']
        db.create_unique(u'mitesting_randomword', ['question_id', 'name'])

        # Adding unique constraint on 'RandomNumber', fields ['question', 'name']
        db.create_unique(u'mitesting_randomnumber', ['question_id', 'name'])

        # Adding unique constraint on 'Expression', fields ['question', 'name']
        db.create_unique(u'mitesting_expression', ['question_id', 'name'])

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.question_spacing2'
        db.add_column(u'mitesting_question', 'question_spacing2',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)

        # Adding field 'QuestionSubpart.question_spacing2'
        db.add_column(u'mitesting_questionsubpart', 'question_spacing2',
                      self.gf('django.db.models.fields.CharField')(max_length=20, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.question_spacing2'
        db.delete_column(u'mitesting_question', 'question_spacing2')

        # Deleting field 'QuestionSubpart.question_spacing2'
        db.delete_column(u'mitesting_questionsubpart', 'question_spacing2')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'QuestionReferencePage.sort_order'
        db.alter_column(u'mitesting_questionreferencepage', 'sort_order', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'QuestionSpacing.sort_order'
        db.alter_column(u'mitesting_questionspacing', 'sort_order', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'QuestionSubpart.sort_order'
        db.alter_column(u'mitesting_questionsubpart', 'sort_order', self.gf('django.db.models.fields.FloatField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'QuestionReferencePage.sort_order'
        db.alter_column(u'mitesting_questionreferencepage', 'sort_order', self.gf('django.db.models.fields.SmallIntegerField')())

        # Changing field 'QuestionSpacing.sort_order'
        db.alter_column(u'mitesting_questionspacing', 'sort_order', self.gf('django.db.models.fields.SmallIntegerField')())

        # Changing field 'QuestionSubpart.sort_order'
        db.alter_column(u'mitesting_questionsubpart', 'sort_order', self.gf('django.db.models.fields.SmallIntegerField')())

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'Expression.expand_on_compare' to 'Expression.normalize_on_compare'
        db.rename_column(u'mitesting_expression', 'expand_on_compare','normalize_on_compare')



    def backwards(self, orm):
        # Renaming field 'Expression.normalize_on_compare' to 'Expression.expand_on_compare'
        db.rename_column(u'mitesting_expression', 'normalize_on_compare', 'expand_on_compare')

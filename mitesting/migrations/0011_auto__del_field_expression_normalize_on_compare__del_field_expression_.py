...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Expression.normalize_on_compare'
        db.delete_column(u'mitesting_expression', 'normalize_on_compare')

        # Deleting field 'Expression.split_symbols_on_compare'
        db.delete_column(u'mitesting_expression', 'split_symbols_on_compare')


    def backwards(self, orm):
        # Adding field 'Expression.normalize_on_compare'
        db.add_column(u'mitesting_expression', 'normalize_on_compare',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Expression.split_symbols_on_compare'
        db.add_column(u'mitesting_expression', 'split_symbols_on_compare',

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'RandomWord.treat_as_function'
        db.add_column(u'mitesting_randomword', 'treat_as_function',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'RandomWord.treat_as_function'
        db.delete_column(u'mitesting_randomword', 'treat_as_function')

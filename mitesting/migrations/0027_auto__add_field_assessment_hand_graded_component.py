...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Assessment.hand_graded_component'
        db.add_column(u'mitesting_assessment', 'hand_graded_component',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Assessment.hand_graded_component'
        db.delete_column(u'mitesting_assessment', 'hand_graded_component')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PlotFunction.condition_to_show'
        db.add_column(u'mitesting_plotfunction', 'condition_to_show',
                      self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PlotFunction.condition_to_show'
        db.delete_column(u'mitesting_plotfunction', 'condition_to_show')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Assessment.nothing_random'
        db.add_column(u'mitesting_assessment', 'nothing_random',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Assessment.nothing_random'
        db.delete_column(u'mitesting_assessment', 'nothing_random')

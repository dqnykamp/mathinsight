...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Assessment.detailed_description'
        db.add_column(u'mitesting_assessment', 'detailed_description',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Assessment.detailed_description'
        db.delete_column(u'mitesting_assessment', 'detailed_description')

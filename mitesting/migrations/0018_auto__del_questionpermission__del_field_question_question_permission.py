...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Question.question_permission'
        db.delete_column(u'mitesting_question', 'question_permission_id')
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'Question.question_permission'
        raise RuntimeError("Cannot reverse this migration. 'Question.question_permission' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'Question.question_permission'
        db.add_column(u'mitesting_question', 'question_permission',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mitesting.QuestionPermission']),
                      keep_default=False)

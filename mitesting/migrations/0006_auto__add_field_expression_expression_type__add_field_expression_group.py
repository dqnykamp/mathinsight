...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Expression.expression_type'
        db.add_column(u'mitesting_expression', 'expression_type',
                      self.gf('django.db.models.fields.CharField')(default=u'EX', max_length=2),
                      keep_default=False)

        # Adding field 'Expression.evaluate_level'
        db.add_column(u'mitesting_expression', 'evaluate_level',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)

        # Adding field 'Expression.group'
        db.add_column(u'mitesting_expression', 'group',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Expression.expression_type'
        db.delete_column(u'mitesting_expression', 'expression_type')

        # Deleting field 'Expression.evaluate_level'
        db.delete_column(u'mitesting_expression', 'evaluate_level')

        # Deleting field 'Expression.group'
        db.delete_column(u'mitesting_expression', 'group')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Expression.randomize_list'
        db.delete_column(u'mitesting_expression', 'randomize_list')

        # Deleting field 'Expression.sort_list'
        db.delete_column(u'mitesting_expression', 'sort_list')

        # Deleting field 'Expression.required_condition'
        db.delete_column(u'mitesting_expression', 'required_condition')

        # Deleting field 'Expression.doit'
        db.delete_column(u'mitesting_expression', 'doit')

        # Deleting field 'Expression.tuple_is_unordered'
        db.delete_column(u'mitesting_expression', 'tuple_is_unordered')
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Expression.randomize_list'
        db.add_column(u'mitesting_expression', 'randomize_list',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Expression.sort_list'
        db.add_column(u'mitesting_expression', 'sort_list',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Expression.required_condition'
        db.add_column(u'mitesting_expression', 'required_condition',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Expression.doit'
        db.add_column(u'mitesting_expression', 'doit',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Expression.tuple_is_unordered'
        db.add_column(u'mitesting_expression', 'tuple_is_unordered',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

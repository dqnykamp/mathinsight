...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Expression.n_digits'
        db.delete_column(u'mitesting_expression', 'n_digits')

        # Deleting field 'Expression.round_decimals'
        db.delete_column(u'mitesting_expression', 'round_decimals')


    def backwards(self, orm):
        # Adding field 'Expression.n_digits'
        db.add_column(u'mitesting_expression', 'n_digits',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Expression.round_decimals'
        db.add_column(u'mitesting_expression', 'round_decimals',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

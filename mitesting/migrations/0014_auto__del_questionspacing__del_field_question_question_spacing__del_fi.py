...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Question.question_spacing'
        db.delete_column(u'mitesting_question', 'question_spacing_id')

        # Deleting field 'QuestionSubpart.question_spacing'
        db.delete_column(u'mitesting_questionsubpart', 'question_spacing_id')
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'mitesting_questionspacing', (
            ...
            ('css_code', self.gf('django.db.models.fields.SlugField')(max_length=50, unique=True)),
        ))
        db.send_create_signal(u'mitesting', ['QuestionSpacing'])

        # Adding field 'Question.question_spacing'
        db.add_column(u'mitesting_question', 'question_spacing',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mitesting.QuestionSpacing'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'QuestionSubpart.question_spacing'
        db.add_column(u'mitesting_questionsubpart', 'question_spacing',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mitesting.QuestionSpacing'], null=True, blank=True),
                      keep_default=False)
    ...
    models = {
        ...
        u'mitesting.question': {
            ...
            'question_spacing2': ('django.db.models.fields.CharField', [], {'max_length': '20', 'null': 'True', 'blank': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestionAnswerOption.round_on_compare'
        db.add_column(u'mitesting_questionansweroption', 'round_on_compare',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'QuestionAnswerOption.round_absolute'
        db.add_column(u'mitesting_questionansweroption', 'round_absolute',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'QuestionAnswerOption.round_partial_credit'
        db.add_column(u'mitesting_questionansweroption', 'round_partial_credit',
                      self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestionAnswerOption.round_on_compare'
        db.delete_column(u'mitesting_questionansweroption', 'round_on_compare')

        # Deleting field 'QuestionAnswerOption.round_absolute'
        db.delete_column(u'mitesting_questionansweroption', 'round_absolute')

        # Deleting field 'QuestionAnswerOption.round_partial_credit'
        db.delete_column(u'mitesting_questionansweroption', 'round_partial_credit')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SympyCommandSet.default'
        db.add_column(u'mitesting_sympycommandset', 'default',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SympyCommandSet.default'
        db.delete_column(u'mitesting_sympycommandset', 'default')

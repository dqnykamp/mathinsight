...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Assessment.total_points'
        db.add_column(u'mitesting_assessment', 'total_points',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Assessment.total_points'
        db.delete_column(u'mitesting_assessment', 'total_points')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Expression.post_user_response'
        db.add_column(u'mitesting_expression', 'post_user_response',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Expression.post_user_response'
        db.delete_column(u'mitesting_expression', 'post_user_response')

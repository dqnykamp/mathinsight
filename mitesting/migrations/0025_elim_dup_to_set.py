...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for e in orm.Expression.objects.filter(collapse_equal_tuple_elements=True):
            e.expression_type = "SE"
            e.save()

    def backwards(self, orm):
        for e in orm.Expression.objects.filter(expression_type=orm.Expression.SET):
            e.expression_type = "UT"
            e.collapse_equal_tuple_elements=True
            e.save()

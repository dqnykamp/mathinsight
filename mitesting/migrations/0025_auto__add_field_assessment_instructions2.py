...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Assessment.instructions2'
        db.add_column(u'mitesting_assessment', 'instructions2',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Assessment.instructions2'
        db.delete_column(u'mitesting_assessment', 'instructions2')

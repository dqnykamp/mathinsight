...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Expression.output_no_delimiters'
        db.delete_column(u'mitesting_expression', 'output_no_delimiters')

        # Deleting field 'Expression.use_ln'
        db.delete_column(u'mitesting_expression', 'use_ln')

        # Deleting field 'Expression.collapse_equal_tuple_elements'
        db.delete_column(u'mitesting_expression', 'collapse_equal_tuple_elements')

        # Deleting field 'Expression.expand'
        db.delete_column(u'mitesting_expression', 'expand')


    def backwards(self, orm):
        # Adding field 'Expression.output_no_delimiters'
        db.add_column(u'mitesting_expression', 'output_no_delimiters',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Expression.use_ln'
        db.add_column(u'mitesting_expression', 'use_ln',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Expression.collapse_equal_tuple_elements'
        db.add_column(u'mitesting_expression', 'collapse_equal_tuple_elements',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Expression.expand'
        db.add_column(u'mitesting_expression', 'expand',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

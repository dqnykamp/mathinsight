...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.computer_graded'
        db.add_column(u'mitesting_question', 'computer_graded',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.computer_graded'
        db.delete_column(u'mitesting_question', 'computer_graded')

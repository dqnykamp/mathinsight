...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for question in orm.Question.objects.all():
            if question.question_spacing:
                question.question_spacing2 = question.question_spacing.css_code
                question.save()
        for question in orm.QuestionSubpart.objects.all():
            if question.question_spacing:
                question.question_spacing2 = question.question_spacing.css_code
                question.save()

    def backwards(self, orm):
        pass #raise RuntimeError("Backward migration no implemented")

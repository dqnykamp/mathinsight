...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Assessment.short_name'
        db.add_column(u'mitesting_assessment', 'short_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=30, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Assessment.short_name'
        db.delete_column(u'mitesting_assessment', 'short_name')

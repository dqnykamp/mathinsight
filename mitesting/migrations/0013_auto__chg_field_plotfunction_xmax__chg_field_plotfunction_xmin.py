...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PlotFunction.xmax'
        db.alter_column(u'mitesting_plotfunction', 'xmax', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

        # Changing field 'PlotFunction.xmin'
        db.alter_column(u'mitesting_plotfunction', 'xmin', self.gf('django.db.models.fields.CharField')(max_length=200, null=True))

    def backwards(self, orm):

        # Changing field 'PlotFunction.xmax'
        db.alter_column(u'mitesting_plotfunction', 'xmax', self.gf('django.db.models.fields.FloatField')(null=True))

        # Changing field 'PlotFunction.xmin'
        db.alter_column(u'mitesting_plotfunction', 'xmin', self.gf('django.db.models.fields.FloatField')(null=True))

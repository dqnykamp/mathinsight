...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'ExpressionFromAnswer.answer_type'
        db.alter_column(u'mitesting_expressionfromanswer', 'answer_type', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'ExpressionFromAnswer.answer_type'
        db.alter_column(u'mitesting_expressionfromanswer', 'answer_type', self.gf('django.db.models.fields.IntegerField')())

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'Expression.group' to 'Expression.random_list_group'
        db.rename_column(u'mitesting_expression', 'group', 'random_list_group')

    def backwards(self, orm):
        # Renaming field 'Expression.random_list_group' to 'Expression.group'
        db.rename_column(u'mitesting_expression', 'random_list_group', 'group')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Question.question_permission'
        db.alter_column(u'mitesting_question', 'question_permission_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['mitesting.QuestionPermission']))

    def backwards(self, orm):

        # Changing field 'Question.question_permission'
        db.alter_column(u'mitesting_question', 'question_permission_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mitesting.QuestionPermission'], null=True))

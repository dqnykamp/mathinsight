...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'QuestionReferencePage.question_subpart'
        db.alter_column(u'mitesting_questionreferencepage', 'question_subpart', self.gf('django.db.models.fields.CharField')(max_length=1, null=True))

    def backwards(self, orm):

        # Changing field 'QuestionReferencePage.question_subpart'
        db.alter_column(u'mitesting_questionreferencepage', 'question_subpart', self.gf('django.db.models.fields.SmallIntegerField')(null=True))

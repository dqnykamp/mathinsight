...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        for expression in orm.Expression.objects.all():
            expression.tuple_is_unordered = not expression.tuple_is_ordered
            expression.save()

    def backwards(self, orm):
        for expression in orm.Expression.objects.all():
            expression.tuple_is_ordered = not expression.tuple_is_unordered
            expression.save()

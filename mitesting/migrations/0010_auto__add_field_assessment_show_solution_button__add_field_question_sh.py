...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Assessment.allow_solution_buttons'
        db.add_column(u'mitesting_assessment', 'allow_solution_buttons',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Question.show_solution_button_after_attempts'
        db.add_column(u'mitesting_question', 'show_solution_button_after_attempts',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Assessment.allow_solution_buttons'
        db.delete_column(u'mitesting_assessment', 'allow_solution_buttons')

        # Deleting field 'Question.show_solution_button_after_attempts'
        db.delete_column(u'mitesting_question', 'show_solution_button_after_attempts')

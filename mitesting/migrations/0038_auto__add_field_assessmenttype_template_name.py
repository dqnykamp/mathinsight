...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'AssessmentType.template_base_name'
        db.add_column(u'mitesting_assessmenttype', 'template_base_name',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'AssessmentType.template_base_name'
        db.delete_column(u'mitesting_assessmenttype', 'template_base_name')

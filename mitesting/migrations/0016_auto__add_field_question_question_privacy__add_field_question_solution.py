...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.question_privacy'
        db.add_column(u'mitesting_question', 'question_privacy',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=2),
                      keep_default=False)

        # Adding field 'Question.solution_privacy'
        db.add_column(u'mitesting_question', 'solution_privacy',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.question_privacy'
        db.delete_column(u'mitesting_question', 'question_privacy')

        # Deleting field 'Question.solution_privacy'
        db.delete_column(u'mitesting_question', 'solution_privacy')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ExpressionFromAnswer.real_variables'
        db.add_column(u'mitesting_expressionfromanswer', 'real_variables',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Expression.real_variables'
        db.add_column(u'mitesting_expression', 'real_variables',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ExpressionFromAnswer.real_variables'
        db.delete_column(u'mitesting_expressionfromanswer', 'real_variables')

        # Deleting field 'Expression.real_variables'
        db.delete_column(u'mitesting_expression', 'real_variables')

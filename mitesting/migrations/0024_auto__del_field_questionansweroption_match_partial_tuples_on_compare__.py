...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # rename field 'QuestionAnswerOption.match_partial_tuples_on_compare' to 'match_partial_on_compare'
        db.rename_column(u'mitesting_questionansweroption', 'match_partial_tuples_on_compare', 'match_partial_on_compare')


    def backwards(self, orm):
        # Rename field 'QuestionAnswerOption.match_partial_on_compare' to 'match_partial_tuples_on_compare'
        db.rename_column(u'mitesting_questionansweroption', 'match_partial_on_compare', 'match_partial_tuples_on_compare')

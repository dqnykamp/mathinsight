...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'QuestionSetDetail.points'
        db.alter_column(u'mitesting_questionsetdetail', 'points', self.gf('django.db.models.fields.FloatField')())

    def backwards(self, orm):

        # Changing field 'QuestionSetDetail.points'
        db.alter_column(u'mitesting_questionsetdetail', 'points', self.gf('django.db.models.fields.IntegerField')())

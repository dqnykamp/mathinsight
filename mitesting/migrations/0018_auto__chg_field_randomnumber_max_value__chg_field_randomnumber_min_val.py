...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'RandomNumber.max_value'
        db.alter_column(u'mitesting_randomnumber', 'max_value', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'RandomNumber.min_value'
        db.alter_column(u'mitesting_randomnumber', 'min_value', self.gf('django.db.models.fields.CharField')(max_length=200))

        # Changing field 'RandomNumber.increment'
        db.alter_column(u'mitesting_randomnumber', 'increment', self.gf('django.db.models.fields.CharField')(max_length=200))

    def backwards(self, orm):

        # Changing field 'RandomNumber.max_value'
        db.alter_column(u'mitesting_randomnumber', 'max_value', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'RandomNumber.min_value'
        db.alter_column(u'mitesting_randomnumber', 'min_value', self.gf('django.db.models.fields.FloatField')())

        # Changing field 'RandomNumber.increment'
        db.alter_column(u'mitesting_randomnumber', 'increment', self.gf('django.db.models.fields.FloatField')())

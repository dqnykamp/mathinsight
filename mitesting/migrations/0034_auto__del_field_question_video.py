...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'mitesting_question', 'video_id')


    def backwards(self, orm):
        # Adding field 'Question.video'
        db.add_column(u'mitesting_question', 'video',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['midocs.Video'], null=True, blank=True),
                      keep_default=False)

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Question.allow_expand'
        db.delete_column(u'mitesting_question', 'allow_expand')
    ...
    def backwards(self, orm):
        # Adding field 'Question.allow_expand'
        db.add_column(u'mitesting_question', 'allow_expand',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

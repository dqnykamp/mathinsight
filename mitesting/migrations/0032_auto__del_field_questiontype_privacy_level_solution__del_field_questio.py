...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'QuestionType.privacy_level_solution'
        db.delete_column(u'mitesting_questiontype', 'privacy_level_solution')

        # Deleting field 'QuestionType.privacy_level'
        db.delete_column(u'mitesting_questiontype', 'privacy_level')


    def backwards(self, orm):
        # Adding field 'QuestionType.privacy_level_solution'
        db.add_column(u'mitesting_questiontype', 'privacy_level_solution',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'QuestionType.privacy_level'
        db.add_column(u'mitesting_questiontype', 'privacy_level',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=0),
                      keep_default=False)

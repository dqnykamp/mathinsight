...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestionSetDetail.group'
        db.add_column(u'mitesting_questionsetdetail', 'group',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestionSetDetail.group'
        db.delete_column(u'mitesting_questionsetdetail', 'group')

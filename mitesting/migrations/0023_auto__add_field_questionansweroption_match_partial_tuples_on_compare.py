...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestionAnswerOption.match_partial_tuples_on_compare'
        db.add_column(u'mitesting_questionansweroption', 'match_partial_tuples_on_compare',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestionAnswerOption.match_partial_tuples_on_compare'
        db.delete_column(u'mitesting_questionansweroption', 'match_partial_tuples_on_compare')
    ...
    models = {
        ...
        u'mitesting.questionansweroption': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'match_partial_tuples_on_compare': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),

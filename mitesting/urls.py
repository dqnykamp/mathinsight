...
urlpatterns = [
    ...
    url(r'^(?P<course_code>\w+)/(?P<assessment_code>\w+)$', AssessmentView.as_view(), \
            name='assessment'),
    url(r'^(?P<course_code>\w+)/(?P<assessment_code>\w+)/overview$',views.assessment_overview_view, name='assessmentoverview'),
    ...
    url(r'^(?P<course_code>\w+)/(?P<assessment_code>\w+)/avoid$',views.assessment_avoid_question_view, name='assessmentavoidquestion'),
    url(r'^(?P<course_code>\w+)/(?P<assessment_code>\w+)/generate$', GenerateAssessmentView.as_view(), name='assessmentgenerate'),
]

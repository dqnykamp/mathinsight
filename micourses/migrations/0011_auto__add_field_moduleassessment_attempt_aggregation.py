...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ModuleAssessment.attempt_aggregation'
        db.add_column(u'micourses_moduleassessment', 'attempt_aggregation',
                      self.gf('django.db.models.fields.CharField')(default='Max', max_length=3),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ModuleAssessment.attempt_aggregation'
        db.delete_column(u'micourses_moduleassessment', 'attempt_aggregation')

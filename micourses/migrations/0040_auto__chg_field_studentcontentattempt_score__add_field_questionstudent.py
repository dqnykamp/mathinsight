...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'StudentContentAttempt.score'
        db.alter_column(u'micourses_studentcontentattempt', 'score', self.gf('django.db.models.fields.FloatField')(null=True))
        # Adding field 'QuestionStudentAnswer.question_set'
        db.add_column(u'micourses_questionstudentanswer', 'question_set',
                      self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True),
                      keep_default=False)


        # Changing field 'QuestionStudentAnswer.answer'
        db.alter_column(u'micourses_questionstudentanswer', 'answer', self.gf('django.db.models.fields.CharField')(max_length=400, null=True))

    def backwards(self, orm):

        # Changing field 'StudentContentAttempt.score'
        db.alter_column(u'micourses_studentcontentattempt', 'score', self.gf('django.db.models.fields.IntegerField')(null=True))
        # Deleting field 'QuestionStudentAnswer.question_set'
        db.delete_column(u'micourses_questionstudentanswer', 'question_set')


        # Changing field 'QuestionStudentAnswer.answer'
        db.alter_column(u'micourses_questionstudentanswer', 'answer', self.gf('django.db.models.fields.CharField')(default=' ', max_length=400))

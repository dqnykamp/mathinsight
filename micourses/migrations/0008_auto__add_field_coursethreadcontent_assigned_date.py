...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourseThreadContent.assigned_date'
        db.add_column(u'micourses_coursethreadcontent', 'assigned_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CourseThreadContent.assigned_date'
        db.delete_column(u'micourses_coursethreadcontent', 'assigned_date')
    ...
    models = {
        ...
        u'micourses.course': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'instructor_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            ...
            'syllabus_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'}),
            ...
            'tutoring_url': ('django.db.models.fields.URLField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'})
        },
        ...
        u'micourses.coursethreadcontent': {
            ...
            'assigned_date': ('django.db.models.fields.DateField', [], {'null': 'True', 'blank': 'True'}),
        ...
        u'micourses.studentattendance': {
            'Meta': {'unique_together': "([u'course', u'student', u'date'],)", 'object_name': 'StudentAttendance'},
            'course': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['micourses.Course']"}),
            'date': ('django.db.models.fields.DateField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourseAssessmentCategory.rescale_factor'
        db.add_column(u'micourses_courseassessmentcategory', 'rescale_factor',
                      self.gf('django.db.models.fields.FloatField')(default=1.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CourseAssessmentCategory.rescale_factor'
        db.delete_column(u'micourses_courseassessmentcategory', 'rescale_factor')

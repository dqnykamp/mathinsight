...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'StudentContentCompletion.score'
        db.alter_column(u'micourses_studentcontentcompletion', 'score', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'StudentContentCompletion.score'
        db.alter_column(u'micourses_studentcontentcompletion', 'score', self.gf('django.db.models.fields.IntegerField')(default=0))

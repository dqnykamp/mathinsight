...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourseEnrollment.group'
        db.add_column(u'micourses_courseenrollment', 'group',
                      self.gf('django.db.models.fields.SlugField')(max_length=20, null=True, blank=True),
                      keep_default=False)


        # Changing field 'CourseEnrollment.section'
        db.alter_column(u'micourses_courseenrollment', 'section', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):
        # Deleting field 'CourseEnrollment.group'
        db.delete_column(u'micourses_courseenrollment', 'group')


        # Changing field 'CourseEnrollment.section'
        db.alter_column(u'micourses_courseenrollment', 'section', self.gf('django.db.models.fields.IntegerField')(default=0))

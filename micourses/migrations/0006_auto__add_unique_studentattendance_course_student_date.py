...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'StudentAttendance', fields ['course', 'student', 'date']
        db.create_unique(u'micourses_studentattendance', ['course_id', 'student_id', 'date'])


    def backwards(self, orm):
        # Removing unique constraint on 'StudentAttendance', fields ['course', 'student', 'date']
        db.delete_unique(u'micourses_studentattendance', ['course_id', 'student_id', 'date'])

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.attendance_threshold_percent'
        db.add_column(u'micourses_course', 'attendance_threshold_percent',
                      self.gf('django.db.models.fields.SmallIntegerField')(default=75),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.attendance_threshold_percent'
        db.delete_column(u'micourses_course', 'attendance_threshold_percent')

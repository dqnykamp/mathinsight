...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'CourseThreadContent', fields ['thread_content', 'course']
        db.create_unique(u'micourses_coursethreadcontent', ['thread_content_id', 'course_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'CourseThreadContent', fields ['thread_content', 'course']
        db.delete_unique(u'micourses_coursethreadcontent', ['thread_content_id', 'course_id'])

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestionStudentAnswer.identifier_in_answer'
        db.add_column(u'micourses_questionstudentanswer', 'identifier_in_answer',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestionStudentAnswer.identifier_in_answer'
        db.delete_column(u'micourses_questionstudentanswer', 'identifier_in_answer')

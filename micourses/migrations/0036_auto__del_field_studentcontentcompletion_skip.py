...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'StudentContentCompletion.skip'
        db.delete_column(u'micourses_studentcontentcompletion', 'skip')


    def backwards(self, orm):
        # Adding field 'StudentContentCompletion.skip'
        db.add_column(u'micourses_studentcontentcompletion', 'skip',

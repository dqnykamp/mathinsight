...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourseThreadContent.record_scores'
        db.add_column(u'micourses_coursethreadcontent', 'record_scores',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CourseThreadContent.record_scores'
        db.delete_column(u'micourses_coursethreadcontent', 'record_scores')

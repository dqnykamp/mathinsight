...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'ManualDueDateAdjustment', fields ['module_assessment', 'student']
        db.delete_unique(u'micourses_manualduedateadjustment', ['module_assessment_id', 'student_id'])

        # Removing unique constraint on 'ModuleAssessment', fields ['module', 'assessment']
        db.delete_unique(u'micourses_moduleassessment', ['module_id', 'assessment_id'])

        # Removing unique constraint on 'Module', fields ['course', 'code']
        db.delete_unique(u'micourses_module', ['course_id', 'code'])
        ...
        db.alter_column(u'micourses_course', 'end_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 6, 1, 0, 0)))

        # Changing field 'Course.start_date'
        db.alter_column(u'micourses_course', 'start_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 6, 1, 0, 0)))
    ...
    def backwards(self, orm):
        ...
        # Adding unique constraint on 'Module', fields ['course', 'code']
        db.create_unique(u'micourses_module', ['course_id', 'code'])
        ...
        # Adding unique constraint on 'ModuleAssessment', fields ['module', 'assessment']
        db.create_unique(u'micourses_moduleassessment', ['module_id', 'assessment_id'])
        ...
        # Adding unique constraint on 'ManualDueDateAdjustment', fields ['module_assessment', 'student']
        db.create_unique(u'micourses_manualduedateadjustment', ['module_assessment_id', 'student_id'])
        ...
        # Changing field 'Course.end_date'
        db.alter_column(u'micourses_course', 'end_date', self.gf('django.db.models.fields.DateField')(null=True))

        # Changing field 'Course.start_date'
        db.alter_column(u'micourses_course', 'start_date', self.gf('django.db.models.fields.DateField')(null=True))
    ...
    models = {
        ...
        u'micourses.questionstudentanswer': {
            ...
            'course_content': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['micourses.StudentContentCompletion']", 'null': 'True', 'blank': 'True'}),
        ...
        u'micourses.studentcontentcompletion': {
            'Meta': {'ordering': "['datetime']", 'object_name': 'StudentContentCompletion'},

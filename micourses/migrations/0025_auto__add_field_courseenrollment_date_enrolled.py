...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourseEnrollment.date_enrolled'
        db.add_column(u'micourses_courseenrollment', 'date_enrolled',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 5, 31, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CourseEnrollment.date_enrolled'
        db.delete_column(u'micourses_courseenrollment', 'date_enrolled')

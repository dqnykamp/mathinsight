...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'micourses_courseenrollment', 'student_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['micourses.CourseUser']))

        # Changing field 'CourseLoggedIn.student'
        db.alter_column(u'micourses_courseloggedin', 'student_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['micourses.CourseUser'], unique=True))

        # Changing field 'StudentAssessmentAttempt.student'
        db.alter_column(u'micourses_studentassessmentattempt', 'student_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['micourses.CourseUser']))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'CourseLoggedIn.student'
        db.alter_column(u'micourses_courseloggedin', 'student_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['micourses.Student'], unique=True))
    ...
    models = {
        ...
        u'micourses.courseloggedin': {
            ...
            'course': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['micourses.Course']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'student': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['micourses.CourseUser']", 'unique': 'True'})
        },

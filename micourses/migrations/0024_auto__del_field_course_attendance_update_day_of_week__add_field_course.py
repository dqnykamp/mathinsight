...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Course.attendance_update_day_of_week'
        db.delete_column(u'micourses_course', 'attendance_update_day_of_week')

        # Adding field 'Course.attendance_end_of_week'
        db.add_column(u'micourses_course', 'attendance_end_of_week',
                      self.gf('django.db.models.fields.CharField')(default='F', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Course.attendance_update_day_of_week'
        db.add_column(u'micourses_course', 'attendance_update_day_of_week',
                      self.gf('django.db.models.fields.CharField')(default='F', max_length=2),
                      keep_default=False)

        # Deleting field 'Course.attendance_end_of_week'
        db.delete_column(u'micourses_course', 'attendance_end_of_week')

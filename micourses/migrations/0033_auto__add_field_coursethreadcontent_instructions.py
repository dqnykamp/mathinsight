...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourseThreadContent.instructions'
        db.add_column(u'micourses_coursethreadcontent', 'instructions',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CourseThreadContent.instructions'
        db.delete_column(u'micourses_coursethreadcontent', 'instructions')

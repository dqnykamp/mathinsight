...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CourseAssessmentCategory.number_count_for_grade'
        db.alter_column(u'micourses_courseassessmentcategory', 'number_count_for_grade', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):

        # Changing field 'CourseAssessmentCategory.number_count_for_grade'
        db.alter_column(u'micourses_courseassessmentcategory', 'number_count_for_grade', self.gf('django.db.models.fields.IntegerField')())

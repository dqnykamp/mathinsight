...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ModuleAssessment.sort_order'
        db.add_column(u'micourses_moduleassessment', 'sort_order',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ModuleAssessment.sort_order'
        db.delete_column(u'micourses_moduleassessment', 'sort_order')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StudentContentAttempt.seed'
        db.add_column(u'micourses_studentcontentattempt', 'seed',
                      self.gf('django.db.models.fields.CharField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'StudentContentAttempt.seed'
        db.delete_column(u'micourses_studentcontentattempt', 'seed')

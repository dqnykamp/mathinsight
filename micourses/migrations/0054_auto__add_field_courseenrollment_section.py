...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourseEnrollment.section'
        db.add_column(u'micourses_courseenrollment', 'section',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CourseEnrollment.section'
        db.delete_column(u'micourses_courseenrollment', 'section')

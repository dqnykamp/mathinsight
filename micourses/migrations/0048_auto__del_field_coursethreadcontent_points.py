...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'CourseThreadContent.points'
        db.delete_column(u'micourses_coursethreadcontent', 'points')


    def backwards(self, orm):
        # Adding field 'CourseThreadContent.points'
        db.add_column(u'micourses_coursethreadcontent', 'points',

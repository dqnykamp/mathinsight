...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'micourses_course', 'short_name',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)

        # Adding field 'Course.semester'
        db.add_column(u'micourses_course', 'semester',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=50),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'micourses_course', 'short_name')

        # Deleting field 'Course.semester'
        db.delete_column(u'micourses_course', 'semester')

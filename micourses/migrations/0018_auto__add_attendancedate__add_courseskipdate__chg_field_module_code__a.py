...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Module.code'
        db.alter_column(u'micourses_module', 'code', self.gf('django.db.models.fields.SlugField')(default=1, max_length=50))
        # Adding field 'Course.days_of_week'
        db.add_column(u'micourses_course', 'days_of_week',
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Module.code'
        db.alter_column(u'micourses_module', 'code', self.gf('django.db.models.fields.SlugField')(max_length=50, null=True))
        # Deleting field 'Course.days_of_week'
        db.delete_column(u'micourses_course', 'days_of_week')
    ...
    models = {
        ...
        u'micourses.attendancedate': {
            'Meta': {'object_name': 'AttendanceDate'},
        ...
        u'micourses.course': {
            ...
            'associated_thread': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['mithreads.Thread']", 'null': 'True', 'blank': 'True'}),

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'micourses_coursegradecategory', (
            ...
            ('number_count_for_grade', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'micourses', ['CourseGradeCategory'])

        # Adding field 'ModuleAssessment.max_number_attempts'
        db.add_column(u'micourses_moduleassessment', 'max_number_attempts',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'ModuleAssessment.max_number_attempts'
        db.delete_column(u'micourses_moduleassessment', 'max_number_attempts')
    ...
    models = {
        ...
        u'micourses.coursegradecategory': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'number_count_for_grade': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },

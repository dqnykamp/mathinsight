...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Course.thread'
        db.alter_column(u'micourses_course', 'thread_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['mithreads.Thread']))

    def backwards(self, orm):

        # Changing field 'Course.thread'
        db.alter_column(u'micourses_course', 'thread_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mithreads.Thread'], null=True))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'StudentContentAttempt.datetime_added'
        db.add_column(u'micourses_studentcontentattempt', 'datetime_added',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2013, 6, 17, 0, 0), blank=True),
                      keep_default=False)


        # Changing field 'StudentContentAttempt.datetime'
        db.alter_column(u'micourses_studentcontentattempt', 'datetime', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):
        # Deleting field 'StudentContentAttempt.datetime_added'
        db.delete_column(u'micourses_studentcontentattempt', 'datetime_added')


        # Changing field 'StudentContentAttempt.datetime'
        db.alter_column(u'micourses_studentcontentattempt', 'datetime', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.tutoring_url'
        db.add_column(u'micourses_course', 'tutoring_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.tutoring_url'
        db.delete_column(u'micourses_course', 'tutoring_url')

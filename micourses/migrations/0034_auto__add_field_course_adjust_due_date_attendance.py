...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.adjust_due_date_attendance'
        db.add_column(u'micourses_course', 'adjust_due_date_attendance',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.adjust_due_date_attendance'
        db.delete_column(u'micourses_course', 'adjust_due_date_attendance')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_unique(u'micourses_module', ['name'])


        # Changing field 'ModuleAssessment.required_for_grade'
        db.alter_column(u'micourses_moduleassessment', 'required_for_grade_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['micourses.GradeLevel'], null=True))
        # Deleting field 'Module.code'
        db.delete_column(u'micourses_module', 'code')


    def backwards(self, orm):

        # Changing field 'ModuleAssessment.required_for_grade'
        db.alter_column(u'micourses_moduleassessment', 'required_for_grade_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['micourses.GradeLevel']))
        # Adding field 'Module.code'
        db.add_column(u'micourses_module', 'code',
                      self.gf('django.db.models.fields.SlugField')(default='a_code', max_length=50, unique=True),
                      keep_default=False)

        # Adding unique constraint on 'Module', fields ['name']
        db.create_unique(u'micourses_module', ['name'])

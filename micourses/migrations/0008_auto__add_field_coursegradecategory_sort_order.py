...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourseGradeCategory.sort_order'
        db.add_column(u'micourses_coursegradecategory', 'sort_order',
                      self.gf('django.db.models.fields.FloatField')(default=0.0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CourseGradeCategory.sort_order'
        db.delete_column(u'micourses_coursegradecategory', 'sort_order')

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'QuestionStudentAnswer.assessment'
        db.add_column(u'micourses_questionstudentanswer', 'assessment',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mitesting.Assessment'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'QuestionStudentAnswer.assessment'
        db.delete_column(u'micourses_questionstudentanswer', 'assessment_id')

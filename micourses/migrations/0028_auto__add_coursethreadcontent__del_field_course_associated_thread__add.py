...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Course.associated_thread'
        db.delete_column(u'micourses_course', 'associated_thread_id')

        # Adding field 'Course.thread'
        db.add_column(u'micourses_course', 'thread',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mithreads.Thread'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Course.associated_thread'
        db.add_column(u'micourses_course', 'associated_thread',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['mithreads.Thread'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Course.thread'
        db.delete_column(u'micourses_course', 'thread_id')
    ...
    models = {
        ...
        u'micourses.coursethreadcontent': {
            'Meta': {'object_name': 'CourseThreadContent'},
        ...
        u'micourses.manualduedateadjustment': {
            'Meta': {'unique_together': "(('module_assessment', 'student'),)", 'object_name': 'ManualDueDateAdjustment'},
        ...
        u'micourses.studentassessmentattempt': {
            'Meta': {'ordering': "['datetime']", 'object_name': 'StudentAssessmentAttempt'},

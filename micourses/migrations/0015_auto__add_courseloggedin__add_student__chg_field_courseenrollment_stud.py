...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CourseLoggedIn'
        db.create_table(u'micourses_courseloggedin', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('student', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['micourses.Student'], unique=True)),
            ('course', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['micourses.Course'])),
        ))
        db.send_create_signal(u'micourses', ['CourseLoggedIn'])

        # Adding model 'Student'
        db.create_table(u'micourses_student', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'micourses', ['Student'])


        # Changing field 'CourseEnrollment.student'
        db.alter_column(u'micourses_courseenrollment', 'student_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['micourses.Student']))
        # Adding field 'Course.start_date'
        db.add_column(u'micourses_course', 'start_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.end_date'
        db.add_column(u'micourses_course', 'end_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.active'
        db.add_column(u'micourses_course', 'active',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


        # Changing field 'StudentAssessmentAttempt.student'
        db.alter_column(u'micourses_studentassessmentattempt', 'student_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['micourses.Student']))

    def backwards(self, orm):
        # Deleting model 'CourseLoggedIn'
        db.delete_table(u'micourses_courseloggedin')

        # Deleting model 'Student'
        db.delete_table(u'micourses_student')


        # Changing field 'CourseEnrollment.student'
        db.alter_column(u'micourses_courseenrollment', 'student_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
        # Deleting field 'Course.start_date'
        db.delete_column(u'micourses_course', 'start_date')

        # Deleting field 'Course.end_date'
        db.delete_column(u'micourses_course', 'end_date')

        # Deleting field 'Course.active'
        db.delete_column(u'micourses_course', 'active')


        # Changing field 'StudentAssessmentAttempt.student'
        db.alter_column(u'micourses_studentassessmentattempt', 'student_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User']))
    ...
    models = {
        ...
        u'micourses.course': {
            ...
            'enrolled_students': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['micourses.Student']", 'through': u"orm['micourses.CourseEnrollment']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '50'}),
        ...
        u'micourses.courseenrollment': {
            ...
            'course': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['micourses.Course']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'student': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['micourses.Student']"}),
            'withdrew': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
        u'micourses.courseloggedin': {
            'Meta': {'object_name': 'CourseLoggedIn'},
            'course': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['micourses.Course']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'student': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['micourses.Student']", 'unique': 'True'})
        },
        ...
        u'micourses.module': {
            'Meta': {'unique_together': "(('course', 'code'),)", 'object_name': 'Module'},
        ...
        u'micourses.moduleassessment': {
            'Meta': {'unique_together': "(('module', 'assessment'),)", 'object_name': 'ModuleAssessment'},

...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'StudentAssessmentAttempt.user'
        db.delete_column(u'micourses_studentassessmentattempt', 'user_id')

        # Deleting field 'StudentAssessmentAttempt.date'
        db.delete_column(u'micourses_studentassessmentattempt', 'date')

        # Adding field 'StudentAssessmentAttempt.student'
        db.add_column(u'micourses_studentassessmentattempt', 'student',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'StudentAssessmentAttempt.datetime'
        db.add_column(u'micourses_studentassessmentattempt', 'datetime',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 5, 25, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'StudentAssessmentAttempt.user'
        db.add_column(u'micourses_studentassessmentattempt', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User']),
                      keep_default=False)

        # Adding field 'StudentAssessmentAttempt.date'
        db.add_column(u'micourses_studentassessmentattempt', 'date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 5, 25, 0, 0)),
                      keep_default=False)

        # Deleting field 'StudentAssessmentAttempt.student'
        db.delete_column(u'micourses_studentassessmentattempt', 'student_id')

        # Deleting field 'StudentAssessmentAttempt.datetime'
        db.delete_column(u'micourses_studentassessmentattempt', 'datetime')
    ...
    models = {
        ...
        u'micourses.course': {
            ...
            'grade_categories': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['micourses.GradeCategory']", 'through': u"orm['micourses.CourseGradeCategory']", 'symmetrical': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '50'})
        },
        u'micourses.coursegradecategory': {
            'Meta': {'object_name': 'CourseGradeCategory'},
            'course': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['micourses.Course']"}),
            'grade_category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['micourses.GradeCategory']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'number_count_for_grade': ('django.db.models.fields.IntegerField', [], {'default': '9999'})
        },
        u'micourses.gradecategory': {
        ...
        u'micourses.moduleassessment': {
            ...
            'grade_category': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['micourses.GradeCategory']", 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),

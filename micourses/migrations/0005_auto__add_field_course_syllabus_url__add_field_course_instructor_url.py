...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Course.syllabus_url'
        db.add_column(u'micourses_course', 'syllabus_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Course.instructor_url'
        db.add_column(u'micourses_course', 'instructor_url',
                      self.gf('django.db.models.fields.URLField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Course.syllabus_url'
        db.delete_column(u'micourses_course', 'syllabus_url')

        # Deleting field 'Course.instructor_url'
        db.delete_column(u'micourses_course', 'instructor_url')

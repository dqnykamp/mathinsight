...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CourseThreadContent.individualize_by_student'
        db.add_column(u'micourses_coursethreadcontent', 'individualize_by_student',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CourseThreadContent.individualize_by_student'
        db.delete_column(u'micourses_coursethreadcontent', 'individualize_by_student')

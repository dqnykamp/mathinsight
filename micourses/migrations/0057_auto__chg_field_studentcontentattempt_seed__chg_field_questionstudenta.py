...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'StudentContentAttempt.seed'
        db.alter_column(u'micourses_studentcontentattempt', 'seed', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'QuestionStudentAnswer.assessment_seed'
        db.alter_column(u'micourses_questionstudentanswer', 'assessment_seed', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

        # Changing field 'QuestionStudentAnswer.seed'
        db.alter_column(u'micourses_questionstudentanswer', 'seed', self.gf('django.db.models.fields.CharField')(max_length=150, null=True))

    def backwards(self, orm):

        # Changing field 'StudentContentAttempt.seed'
        db.alter_column(u'micourses_studentcontentattempt', 'seed', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'QuestionStudentAnswer.assessment_seed'
        db.alter_column(u'micourses_questionstudentanswer', 'assessment_seed', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

        # Changing field 'QuestionStudentAnswer.seed'
        db.alter_column(u'micourses_questionstudentanswer', 'seed', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))

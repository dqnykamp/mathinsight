...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Course.next_attendance_date'
        db.delete_column(u'micourses_course', 'next_attendance_date')

        # Adding field 'Course.track_attendance'
        db.add_column(u'micourses_course', 'track_attendance',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Course.last_attendance_date'
        db.add_column(u'micourses_course', 'last_attendance_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Course.next_attendance_date'
        db.add_column(u'micourses_course', 'next_attendance_date',
                      self.gf('django.db.models.fields.DateField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'Course.track_attendance'
        db.delete_column(u'micourses_course', 'track_attendance')

        # Deleting field 'Course.last_attendance_date'
        db.delete_column(u'micourses_course', 'last_attendance_date')

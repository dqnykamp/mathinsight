...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(u'micourses_gradecategory')

        # Deleting model 'CourseGradeCategory'
        db.delete_table(u'micourses_coursegradecategory')
        ...
        db.create_table(u'micourses_courseassessmentcategory', (
            ...
            ('number_count_for_grade', self.gf('django.db.models.fields.IntegerField')(default=9999)),
        ...
        # Deleting field 'ModuleAssessment.grade_category'
        db.delete_column(u'micourses_moduleassessment', 'grade_category_id')

        # Adding field 'ModuleAssessment.assessment_category'
        db.add_column(u'micourses_moduleassessment', 'assessment_category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['micourses.AssessmentCategory'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding model 'GradeCategory'
        db.create_table(u'micourses_gradecategory', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=50, unique=True)),
        ))
        db.send_create_signal(u'micourses', ['GradeCategory'])

        # Adding model 'CourseGradeCategory'
        db.create_table(u'micourses_coursegradecategory', (
            ('number_count_for_grade', self.gf('django.db.models.fields.IntegerField')(default=9999)),
            ('grade_category', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['micourses.GradeCategory'])),
            ('course', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['micourses.Course'])),
            ('sort_order', self.gf('django.db.models.fields.FloatField')(default=0.0)),
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal(u'micourses', ['CourseGradeCategory'])
        ...
        # Adding field 'ModuleAssessment.grade_category'
        db.add_column(u'micourses_moduleassessment', 'grade_category',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['micourses.GradeCategory'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'ModuleAssessment.assessment_category'
        db.delete_column(u'micourses_moduleassessment', 'assessment_category_id')

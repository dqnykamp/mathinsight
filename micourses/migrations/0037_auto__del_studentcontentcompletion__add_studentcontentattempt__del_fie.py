...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'QuestionStudentAnswer.course_content'
        db.delete_column(u'micourses_questionstudentanswer', 'course_content_id')

        # Adding field 'QuestionStudentAnswer.course_content_attempt'
        db.add_column(u'micourses_questionstudentanswer', 'course_content_attempt',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['micourses.StudentContentAttempt'], null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'QuestionStudentAnswer.course_content'
        db.add_column(u'micourses_questionstudentanswer', 'course_content',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['micourses.StudentContentCompletion'], null=True, blank=True),
                      keep_default=False)

        # Deleting field 'QuestionStudentAnswer.course_content_attempt'
        db.delete_column(u'micourses_questionstudentanswer', 'course_content_attempt_id')

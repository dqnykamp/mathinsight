...
urlpatterns = patterns \
    ('micourses.views',
     ...
     url(r'^adjusted_due_date_calculation/(?P<pk>\w+)$','adjusted_due_date_calculation_view', name='mic-adjustedduedatecalculation'),
     url(r'^gradebook/(?P<student_id>\w+)/adjusted_due_date_calculation/(?P<pk>\w+)$','adjusted_due_date_calculation_instructor_view', name='mic-instructoradjustedduedatecalculation'),
     ...
     url(r'^gradebook/export$','export_gradebook_view', name='mic-exportgradebook'),
     url(r'^gradebook/exportcsv$','gradebook_csv_view', name='mic-gradebookcsv'),

...
from mithreads.views import EditSectionView, ReturnContentForm, ReturnContentOptions
...
urlpatterns = [
    ...
    url(r'^edit/section$', 
        EditSectionView.as_view(), name='mithreads-edit-section'),
    url(r'^edit/return_content_form$', 
        ReturnContentForm.as_view(), name='mithreads-return-content-form'),
    url(r'^edit/return_content_options$',
        ReturnContentOptions.as_view(), 
        name='mithreads-return-options'),
]
